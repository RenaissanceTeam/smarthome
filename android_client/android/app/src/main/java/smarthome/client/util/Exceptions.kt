...
class AuthenticationFailed : HomeModelException("Can't use UID because user is not authorized")
...
class NoScriptException(guid: Long) : HomeModelException("No script with guid=$guid")
