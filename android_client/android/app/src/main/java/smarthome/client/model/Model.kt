...
import smarthome.client.NoControllerException
import smarthome.client.NoDeviceException
import smarthome.client.NoDeviceWithControllerException
...
//
//    suspend fun getScriptsObservable(): Observable<MutableList<Script>> = _scriptsObservable
//            ?: createScriptsObservable()
//
...
//    }
//
//    private suspend fun getSmartHome() = smartHome
//            ?: loadHome()
//
//    private suspend fun loadHome(): SmartHome {
//        val smartHome = CloudStorages.loadHome()
//        Model.smartHome = smartHome
//        return smartHome
//    }
//
//    private suspend fun getPendingDevices() = pendingDevices
//            ?: loadPendingDevices()
//
