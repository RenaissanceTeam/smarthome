...
class DeviceSelectorAdapter(private val dataSource: List<Pair<String, Int>>,
                            private val onDeviceClick: (deviceSearchMethod: String, args: String?) -> Unit) :
    RecyclerView.Adapter<DeviceSelectorAdapter.ViewHolder>() {
    
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.device_selector_item_card, parent, false)
    ...
    class ViewHolder(itemView: View,
                     onDeviceClick: (deviceSearchMethod: String, args: String?) -> Unit) :
